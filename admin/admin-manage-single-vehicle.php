    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Motorcycle</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Motorcycle Category</label>
            ...
            <div class="card-body">
                <h5 class="card-title">Motorcycle Picture</h5>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>
            </div>
            <hr>
            <button type="submit" name="upate_veh" class="btn btn-success">Update Motorcycle</button>
          </form>
          <!-- End Form-->
          <?php }?>
        </div>
