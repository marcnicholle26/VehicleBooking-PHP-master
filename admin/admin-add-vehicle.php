    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Motorcycle</li>
        </ol>
        <hr>
        <div class="card">
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            <div class="form-group">
                <label for="exampleInputEmail1">Motorcycle Model</label>
                <input type="text" required class="form-control" id="exampleInputEmail1" name="v_name">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Motorcycle Registration Number</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_reg_no">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Passenger Type</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Motorcycle Type</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Motorcycle Status</label>
            ...
            <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Motorcycle Picture</label>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="v_dpic">
            </div>

            <button type="submit" name="add_veh" class="btn btn-success">Add Motorcycle</button>
          </form>
          <!-- End Form-->
        </div>
      </div>
