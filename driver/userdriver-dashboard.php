...
<head>
  ...
  <title>Motorcycles Booking System - Driver Dashboard</title>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $result ="SELECT count(u_id) FROM tms_user where u_car_book_status = 'Approved' || u_car_book_status = 'Pending' ";
