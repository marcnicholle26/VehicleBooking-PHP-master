    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Motorcycle</li>
          <li class="breadcrumb-item ">Book Motorcycle</li>
        ...
        ?>
          ...
          <div class="form-group">
                <label for="exampleInputEmail1">Motorcycle Category</label>
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Pick Up | Drop Off</label>
                <input type="text" placeholder="Place to pick up | Place to drop off" class="form-control" id="exampleInputEmail1"  name="u_car_bookdate">
            </div>
