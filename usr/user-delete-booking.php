    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Booking Status</li>
        </ol>
        <hr>
        <div class="card">
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Picked Up | Dropped Off</label>
            ...
            <button type="submit" name="delete_booking" class="btn btn-danger">Dropped Off</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
